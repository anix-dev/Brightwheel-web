  ...
  const getData =async()=>{
    try{
     ...
     const res = await api.post("/api/mssql-procedure/execute/get", {
        procedureName: "VehicleDriverGetAll",
        parameters: [],
      });
        if (res.data.success) {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a: TableData, b: TableData) =>
        a.license.length - b.license.length,
    },
    {
      title: "Address",
      dataIndex: "address",
      ...
      <div className="page-wrapper">
        <div className="content">
          ...
          <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
            ...
            <div className="d-flex my-xl-auto align-items-right flex-wrap">
              {/* <TooltipOption /> */}
              <div className="mb-2">
                <Link
                  to="#"
            ...
            <div className="card-body p-0 py-3">
             {
              ...
              <Loading/>
              :
             <Table dataSource={details} columns={columns} Selection={true} />
